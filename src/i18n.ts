...
const STRINGS: Record<string, Record<string, string>> = {
  de: {
    ...
    seriesPart: "Teil {n} von {total}",
    seriesCount: "{count} Teile",
    seriesOverview: "Zur Serienübersicht",
    inThisSeries: "In dieser Serie",
    postsInSeries: "Beiträge der Serie „{series}“.",
    ...
    forbiddenBody: "Für diese Seite fehlt dir die Berechtigung.",
    serverError: "Serverfehler",
    serverErrorBody: "Auf dem Server ist etwas schiefgelaufen. Bitte versuch es später erneut.",
    unavailable: "Vorübergehend nicht erreichbar",
    unavailableBody: "Die Seite ist gerade in Wartung. Sie ist bald wieder da.",
  ...
  en: {
    ...
    postsInSeries: "Posts in the “{series}” series.",
    ...
    serverErrorBody: "Something went wrong on the server. Please try again later.",
    unavailable: "Temporarily unavailable",
    unavailableBody: "The site is down for maintenance. It will be back shortly.",
